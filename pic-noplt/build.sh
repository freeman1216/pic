...
slotopts="-mcpu=cortex-m4 -mfloat-abi=soft -Tslot.ld -ggdb -Wall -Wextra -fjump-tables -nolibc --specs=nosys.specs -nostartfiles -fPIC -fno-plt -fvisibility=hidden  -mthumb"
