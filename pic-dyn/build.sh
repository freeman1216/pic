...
"
slotopts="-mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16  -Tslot.ld -ggdb -Wall -Wextra -fjump-tables -nolibc -fPIC -shared -Wl,-Bsymbolic -Wl,--unresolved-symbols=ignore-all --specs=nosys.specs -nostartfiles -msingle-pic-base -mpic-register=r9  -mthumb"
...
if [ "$build_firm" = "true" ]; then
	arm-none-eabi-gcc $firmopts module.c main.c startup_stm32h562vgt6.c -o build/out.elf
fi
